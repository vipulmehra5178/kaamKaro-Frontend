            ...
            {user && (
              <>
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-semibold bg-red-600/80 hover:bg-red-700 hover:shadow-red-500/30 transition-all duration-300 w-full text-left"
                >
                  <LogOut size={20} />
                  Logout
                </button>
